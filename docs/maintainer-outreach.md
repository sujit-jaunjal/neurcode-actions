...
Current rehearsal ref: `sujit-jaunjal/neurcode-actions@v0.3.0-rc.2`.
...
I am rehearsing `sujit-jaunjal/neurcode-actions@v0.3.0-rc.2`, a free GitHub Action that writes a source-free PR triage report for maintainers.
...
`sujit-jaunjal/neurcode-actions@v0.3.0-rc.2`
